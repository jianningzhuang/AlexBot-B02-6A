...
void handleColour(const char *buffer)
{
    ...
    printf("\n ------- COLOUR------- \n\n");
    printf("redFrequency:\t\t%d\n", data[0]);
    printf("blueFrequency:\t\t%d\n", data[1]);
    printf("greenFrequency:\t\t%d\n", data[2]);
    printf("whiteFrequency:\t\t%d\n", data[3]);
    
    if (data[2] > 60 && data[0] > 60) {
        printf("No color detected");
    } else if (data[2] > data[0]) {
        printf("Green Color detected");
    } else {
        printf("Red Color detected");
    }
    
    
//    if (data[2] < 163 && ((data[0] - data[2]) > 0) && ((data[1] - data[2]) > 15)) {
//        printf("Green Color Detected");//printing name
//    } else if (data[0] < 110 && ((data[2] - data[0]) > 60) && ((data[1] - data[0]) > 60)) {
//         printf("Red Color Detected");//printing name
//    } else {
//        printf("No Color Detected");
//    }
    
//    if (data[0] > 80 && (data[0] > data[2]) && ((data[0] - data[2]) > 20)) {
//        printf("RED!");
//        printf ("%d\n", (data[0] - data[2]) > 20);
//    } else if (data[2] > 80 && (data[2] > data[0]) && ((data[2] - data[0]) > 20)) {
//        printf("GREEN!");
//    } else {
//        printf("No Colour!");
//    }
...
void *writerThread(void *conn)
{
	...
	{
		char ch;
        printf("Command (WASD for smaller movements, IJKL for larger movements, TFGH for movements with params)\n");
        printf("Command (Z = stop, X = data, C = clear, Q = quit)\n");
		scanf("%c", &ch);
